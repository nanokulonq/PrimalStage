...
public class ModBlocks {
    ...
    // Misc Blocks
    public static final Block BUSH_BLOCK = new BushBlock(FabricBlockSettings.create().strength(0.3f).sounds(BlockSoundGroup.CAVE_VINES).nonOpaque());
    public static final Block TWIGS_BLOCK = new TwigsBlock(FabricBlockSettings.create().strength(0.1f).sounds(BlockSoundGroup.WOOD));
    public static final Block PEBBLE_BLOCK = new PebbleBlock(FabricBlockSettings.create().strength(0.1f).sounds(BlockSoundGroup.STONE));
    public static final Block OAK_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block BIRCH_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block JUNGLE_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block DARK_OAK_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block SPRUCE_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block ACACIA_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block MANGROVE_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block CRIMSON_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block WARPED_HEDGE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block OAK_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block BIRCH_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block JUNGLE_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block DARK_OAK_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block SPRUCE_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block ACACIA_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block MANGROVE_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block CRIMSON_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block WARPED_LATTICE = new HedgeBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block OAK_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block BIRCH_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block JUNGLE_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block DARK_OAK_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block SPRUCE_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block ACACIA_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block MANGROVE_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block CRIMSON_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block WARPED_LOGS = new Logs(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block CHARCOAL_LOG = new PillarBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block KILN_BRICKS = new Block(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.STONE).requiresTool());
    public static final Block SALT_BLOCK = new Block(FabricBlockSettings.create().strength(0.6f).sounds(BlockSoundGroup.GRAVEL));
    public static final Block STRAW_BLOCK = new HayBlock(FabricBlockSettings.create().strength(0.5f).sounds(BlockSoundGroup.GRASS));
    // Machines
    public static final Block PRIMITIVE_GRILL = new PrimitiveGrillBlock(2, FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.STONE).requiresTool());
    public static final Block CUTTING_LOG = new CuttingLogBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block STONE_ANVIL = new StoneAnvilBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.STONE).requiresTool());
    public static final Block OAK_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block BIRCH_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block JUNGLE_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block DARK_OAK_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block SPRUCE_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block ACACIA_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block MANGROVE_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block CRIMSON_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block WARPED_DRYING_RACK = new DryingRackBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block OAK_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block BIRCH_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block JUNGLE_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block DARK_OAK_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block SPRUCE_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block ACACIA_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block MANGROVE_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block CRIMSON_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block WARPED_SHELF = new ShelfBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD));
    public static final Block KILN = new KilnBlock(FabricBlockSettings.create().strength(2.0f).sounds(BlockSoundGroup.STONE).requiresTool());
