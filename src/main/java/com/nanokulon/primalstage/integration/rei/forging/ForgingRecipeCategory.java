...
public class ForgingRecipeCategory implements DisplayCategory<ForgingRecipeDisplay> {
    ...
    @Override
    public CategoryIdentifier<? extends ForgingRecipeDisplay> getCategoryIdentifier() {
        return ModReiPlugin.FORGING;
    }

    @Override
    public List<Widget> setupDisplay(ForgingRecipeDisplay display, Rectangle bounds) {
